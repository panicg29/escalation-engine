...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const isInteractiveTarget = (target: EventTarget | null) => {
      ...
      return Boolean(
        target.closest('a, button, input, textarea, select, summary, [role="button"], [data-no-fluid]')
      );
    };
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 opacity-[0.16] dark:opacity-30">
